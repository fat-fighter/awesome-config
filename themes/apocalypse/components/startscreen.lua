...
local function create_controlpanel()
    ----------------------------------------------------------------------------
    -- Creating the StartScreen

    local controlpanel = wibox {visible = false, ontop = true, type = "dock"}
    ...
    if beautiful.bg_image then
        ...
        controlpanel_bg.bgimage = bg_image_function
    end

    controlpanel.bg = beautiful.bg
    controlpanel.fg = beautiful.fg or "#FFFFFF"

    if beautiful.border_radius then
        controlpanel.shape = helpers.rrect(beautiful.border_radius)
    end
    ...
    function controlpanel:show(width, height, x, y)
    ...
    function controlpanel:hide(width, height, x, y)
