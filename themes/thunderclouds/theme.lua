...
calendar.font = {
    ...
    header = "BebasNeue Bold " .. font_size(22),
    normal = "Iosevka Light " .. font_size(13),
    weekday = "Iosevka Medium " .. font_size(14),
    weekend = "Iosevka Medium " .. font_size(14),
    dweekend = "Iosevka Light " .. font_size(13)
}

calendar.bg = {
    focus = background_highlight,
    month = "#00000000",
    header = "#00000000",
    normal = "#00000000",
    weekday = "#00000000",
    weekend = "#00000000",
    dweekend = background_focus .. "33"
}

calendar.fg = {
    focus = foreground_focus,
    month = foreground_title,
    header = foreground_title,
    normal = foreground_normal,
    weekday = foreground_highlight,
    weekend = foreground_highlight,
    dweekend = foreground_normal
}
