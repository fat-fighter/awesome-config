...
local mail_textbox = wibox.widget {
	...
	bg            = beautiful.bg_notification or "#ff0000",
...
helpers.add_clickable_effect(
	mail,
	function ()
		mail.bg = beautiful.bg_hover or "#555555"
	end,
	function ()
		mail.bg = beautiful.bg or "#333333"
	end
)
...
local function update_widget()
	awful.spawn.easy_async_with_shell(
		mail_script,
		function(stdout)
			local count = tonumber(string.match(stdout, "<fullcount>([%d]+)</fullcount>")) or 0
